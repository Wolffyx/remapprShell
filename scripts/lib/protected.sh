...
$PLASMA_SHELLS_DIR/$SHELL_PACKAGE_ID
$PLASMA_SHELLS_DIR/$PLASMA_SHELL_PACKAGE_ID
$XDG_CONFIG_HOME/plasma-$SHELL_PACKAGE_ID-appletsrc
$XDG_CONFIG_HOME/plasma-$PLASMA_SHELL_PACKAGE_ID-appletsrc
$COLORS_DIR/$SLUG-dark.colors
$COLORS_DIR/$SLUG-light.colors
$KWIN_SWITCHER_DIR/$SLUG
$PLASMA_DESKTOPTHEME_DIR/$SLUG
$KWIN_SCRIPTS_DIR/$KWIN_SCRIPT_ID
$DBUS_SERVICES_DIR/$DBUS_NAME.service
OWNED
}
